...
import { FileCode, GitBranch, History, RotateCcw, ShieldCheck } from "lucide-react";
  ...
  return (
    <>
      <WidgetCard
        ...
        actions={
          <button
            className="inline-flex items-center gap-1 rounded-md border border-cyber-blue/30 px-2 py-1 text-[11px] font-semibold text-cyber-blue transition-colors hover:bg-cyber-blue/10"
            onClick={() => {
              /* rollback is UI-only per spec */
            }}
          >
