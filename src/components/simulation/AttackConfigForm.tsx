...
export function AttackConfigForm({
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="w-full rounded-md border border-cyber-pink/50 bg-cyber-pink/15 px-4 py-2 text-sm font-semibold text-cyber-pink transition-colors hover:bg-cyber-pink/25"
      >
